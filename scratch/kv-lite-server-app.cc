...
void KvLiteServerApp::ProcessReceive(const KvLiteRequest &req)
{
    ...
    switch (msgType) {
        case KvLiteMsgType::REQ: {
            ...
            Simulator::Schedule(NanoSeconds(SERVER_OVERHEAD), &KvLiteServerApp::IssueResponse, this, rsp);
            break;
        }
        case KvLiteMsgType::HANDSHAKE: {
            ...
            Simulator::Schedule(NanoSeconds(SERVER_OVERHEAD), &KvLiteServerApp::IssueResponse, this, data);
            break;
        }
        default: {
